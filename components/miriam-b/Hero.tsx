...
import Sun from "@/components/ornaments/Sun";
import Cactus from "@/components/ornaments/Cactus";
import Mountains from "@/components/ornaments/Mountains";
import FlowerBorder from "@/components/ornaments/FlowerBorder";
...
export default function HeroB() {
  ...
  return (
    <section
      ref={ref}
      className="paper-stains relative min-h-[100svh] w-full overflow-hidden text-kraft"
    >
      ...
      >
        ...
        >
          <strong className="text-ochre">Em junho</strong>, deixo minha casa,
