...
function Polaroid({
  ...
  return (
    <motion.figure
      ...
      className="group paper-grain relative mx-auto w-full max-w-sm cursor-pointer bg-cream p-4 shadow-[8px_12px_0_rgba(45,24,16,0.22),0_30px_60px_-20px_rgba(45,24,16,0.55)] md:p-5"
    >
      <span
        aria-hidden="true"
