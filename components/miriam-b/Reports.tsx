...
export default function ReportsB() {
  return (
    <section
      id="prestacao"
    ...
    >
      ...
      <div className="relative z-10 mx-auto max-w-3xl px-6">
        ...
        <motion.h2
          ...
          className="ink-bleed mb-8 text-center font-[var(--font-display)] text-3xl leading-[1.15] text-terracota-dk md:text-5xl"
        >
          Entre no grupo de atualizações
          <br />
          <em className="font-[var(--font-serif)] font-black italic text-ochre">
            para receber meus informativos
          </em>
        </motion.h2>
