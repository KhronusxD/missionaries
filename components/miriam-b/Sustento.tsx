...
const TIERS: Tier[] = [
  { value: 50, label: "R$ 50", emoji: "💚" },
  { value: 100, label: "R$ 100", emoji: "💙" },
...
export default function SustentoB() {
      ...
      <div className="relative z-10 mx-auto max-w-4xl px-6">
        ...
        <TiltCard className="relative mt-12 border-[3px] border-ochre bg-kraft p-8 text-ink shadow-[0_0_0_3px_#2d1810,14px_14px_0_#c94a1f] md:p-12">
          ...
          <p className="mb-5 font-[var(--font-display)] text-sm uppercase tracking-[0.05em] text-terracota-dk">
            Valores que você pode contribuir:
          </p>
          ...
          <div className="mb-8 grid grid-cols-2 gap-3 md:grid-cols-4">
            ...
            <TierOption
              tier={{ value: 0, label: "Outro", emoji: "⭐" }}
...
function TierOption({
  ...
  return (
    <button
      type="button"
      onClick={onSelect}
      className={`group relative flex h-full flex-col items-center justify-center gap-1 rounded-sm border-2 px-3 py-5 text-center transition-all ${
        selected
